...
class ConvAE(object):
    def __init__(self, n_input, kernel_size, n_hidden, reg_constant1=1.0, re_constant2=1.0, re_constant3=1.0,
        ...
        self.x_r = tf.layers.dense(self.x_r, 128, activation=None, name='d4')
        ...
        self.x_r2 = tf.layers.dense(self.x_r2, 128, activation=None, name='d4', reuse=True)
        # self.x_r = self.x_r2
...
def test_face(Img, Label, CAE, num_class, lr2=5e-4):
    ...
    for i in range(0, 8 - num_class):
        ...
        if pred == True:
            ...
            CAE.save_model()
            pred = True
            visualize(Img, Label, CAE, './DSClustering/Results/Result20/tsne-ae.pdf')
        ...
        for posti in range(1):
            ...
            acc_.append(acc_x)
            probs,re_y = prob(L, y_pre)
            # accuracy = cal_acc(label_10_subjs,probs) #和acc_x一样
            data = {
            ...
            file_path = "./DSClustering/Results/Result10/"
...
if __name__ == '__main__':
    data = hdf5storage.loadmat('./DSClustering/data/en_test_all.mat')
    Img = data['data']
    Label = data['gnd']
    ...
    model_path = './DSClustering/Results/Result10/model-fullfc.ckpt'
    restore_path = './DSClustering/Results/Result10/model-fullfc.ckpt'
    logs_path = './DSClustering/Results/Result10/logs'
